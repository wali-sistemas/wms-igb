...
export class ReportManagerComponent implements OnInit {
  ...
  public totalSinVencer: number = 0;
  public total0a20: number = 0;
  public total21a55: number = 0;
  public total56a120: number = 0;
  public total121a360: number = 0;
  public totalMayor360: number = 0;
  /***Cartera por Recaudar***/
  public activeByCollection: boolean = false;
  public byCollect: Array<ByCollect>;
  public totalByCollect: number = 0;
  public totalCarteraSana: number = 0;
  public porcentCarteraSana: number = 0;
  /***Logistica Estado Pedidos***/
  public statusOrders: Array<any> = [];
  public activeStatusOrder: boolean = false;
  public totalPend: number = 0;
  ...
  public selectedYearTimeOper: number = 0;
  ...
  /***COMEX Inhabilitar opcion taller***/
  public activeComex: boolean = false;
  ...
  public onFiltroChange() {
    // Comercial
    if (this.activeSaleAnnual) this.getSalesAnnual();
    if (this.activeSaleMonth) this.getSalesMonthly();
    if (this.activeMargeAnnual) this.getSalesAnnual();
    if (this.activeMargeMonth) this.getSalesMonthly();
    // Cartera
    if (this.activeCollection) this.getCollectMonthly();
    if (this.activeByCollection) this.getByCollect();

    // Logística
    if (this.activeStatusOrder) this.getStatusOrder();
    if (this.activeGraphCedi) this.getStatusOrder();
    if (this.activeOrderOfDay) this.listOrdersOfDay();
  }
  ...
  private initializeComex() {
    ...
    if (this.activeCostoCompra) {
      this.barChartDataCostoCompra = [
        { data: [this.costosCompras[0].costLogistic, this.costosCompras[1].costLogistic, this.costosCompras[2].costLogistic, this.costosCompras[3].costLogistic, this.costosCompras[4].costLogistic, this.costosCompras[5].costLogistic, this.costosCompras[6].costLogistic, this.costosCompras[7].costLogistic, this.costosCompras[8].costLogistic, this.costosCompras[9].costLogistic, this.costosCompras[10].costLogistic, this.costosCompras[11].costLogistic], label: '2023' },
        { data: [this.costosCompras[12].costLogistic, this.costosCompras[13].costLogistic, this.costosCompras[14].costLogistic, this.costosCompras[15].costLogistic, this.costosCompras[16].costLogistic, this.costosCompras[17].costLogistic, this.costosCompras[18].costLogistic, this.costosCompras[19].costLogistic, this.costosCompras[20].costLogistic, this.costosCompras[21].costLogistic, this.costosCompras[22].costLogistic, this.costosCompras[23].costLogistic], label: '2024' },
        { data: [this.costosCompras[24].costLogistic, this.costosCompras[25].costLogistic, this.costosCompras[26].costLogistic, this.costosCompras[27].costLogistic, this.costosCompras[28].costLogistic, this.costosCompras[29].costLogistic, this.costosCompras[30].costLogistic, this.costosCompras[31].costLogistic, this.costosCompras[32].costLogistic, this.costosCompras[33].costLogistic, this.costosCompras[34].costLogistic, this.costosCompras[35].costLogistic], label: '2025' },
        { data: [this.costosCompras[36].costLogistic, this.costosCompras[37].costLogistic, this.costosCompras[38].costLogistic, this.costosCompras[39].costLogistic, this.costosCompras[40].costLogistic, this.costosCompras[41].costLogistic, this.costosCompras[42].costLogistic, this.costosCompras[43].costLogistic, this.costosCompras[44].costLogistic, this.costosCompras[45].costLogistic, this.costosCompras[46].costLogistic, this.costosCompras[47].costLogistic], label: '2026' }
      ];
    }
    /***Informe costo import COMEX***/
    if (this.activeCostoImport) {
      this.barChartDataCostoImport = [
        { data: [this.costosImports[0][1], this.costosImports[1][1], this.costosImports[2][1], this.costosImports[3][1], this.costosImports[4][1], this.costosImports[5][1], this.costosImports[6][1], this.costosImports[7][1], this.costosImports[8][1], this.costosImports[9][1], this.costosImports[10][1], this.costosImports[11][1]], label: '2023' },
        { data: [this.costosImports[0][2], this.costosImports[1][2], this.costosImports[2][2], this.costosImports[3][2], this.costosImports[4][2], this.costosImports[5][2], this.costosImports[6][2], this.costosImports[7][2], this.costosImports[8][2], this.costosImports[9][2], this.costosImports[10][2], this.costosImports[11][2]], label: '2024' },
        { data: [this.costosImports[0][3], this.costosImports[1][3], this.costosImports[2][3], this.costosImports[3][3], this.costosImports[4][3], this.costosImports[5][3], this.costosImports[6][3], this.costosImports[7][3], this.costosImports[8][3], this.costosImports[9][3], this.costosImports[10][3], this.costosImports[11][3]], label: '2025' },
        { data: [this.costosImports[0][4], this.costosImports[1][4], this.costosImports[2][4], this.costosImports[3][4], this.costosImports[4][4], this.costosImports[5][4], this.costosImports[6][4], this.costosImports[7][4], this.costosImports[8][4], this.costosImports[9][4], this.costosImports[10][4], this.costosImports[11][4]], label: '2026' }
      ];
    }
  ...
  public getSalesAnnual() {
    ...
    this._reportService.getSalesAnnual(this.queryParam.id, false, this.isTaller).subscribe(
      response => {
        if (response.code == 0) {
  ...
  public getSalesMonthly() {
    ...
    this._reportService.getSalesMonthly(this.queryParam.id, false, this.isTaller).subscribe(
      response => {
        if (response.code == 0) {
  ...
  public getCollectMonthly() {
    ...
    this._reportService.getSalesCollectMonthly(this.queryParam.id, false, this.isTaller).subscribe(
      response => {
        if (response.code == 0) {
  ...
  public listOrdersOfDay() {
    ...
    this._reportService.listOrdersOfDay(this.queryParam.id, false, this.isTaller).subscribe(
      response => {
  ...
  public getByCollect() {
    ...
    this._reportService.getSalesByCollect(this.queryParam.id, false, this.isTaller).subscribe(
      response => {
        if (response.code == 0) {
          ...
          /*TODO: calculando cartera sana primeros 2 conceptos 1. Sin vencer 2. 0 a 20*/
          for (let i = 0; i < 2; i++) {
  ...
  public getStatusOrder() {
    ...
    this._reportService.getStatesOrder(this.queryParam.id, false, this.isTaller).subscribe(
      response => {
        if (response.code == 0) {
  ...
  public getOrdersCedi() {
    ...
    this._reportService.obtainReportsOrders(this.queryParam.id, '01', false).subscribe(
      response => {
        ...
        console.error("Ocurrio un error al obtener el estado de las ordenes de bodega cedi.", error);
        $('#modal_transfer_process').modal('hide');
        this.redirectIfSessionInvalid(error);
      }
    );
