    ...
    private initializeComex() {
        ...
        if (this.activeCostoCompra) {
            this.barChartDataCostoCompra = [
                { data: [this.costosCompras[0].costLogistic, this.costosCompras[1].costLogistic, this.costosCompras[2].costLogistic, this.costosCompras[3].costLogistic, this.costosCompras[4].costLogistic, this.costosCompras[5].costLogistic, this.costosCompras[6].costLogistic, this.costosCompras[7].costLogistic, this.costosCompras[8].costLogistic, this.costosCompras[9].costLogistic, this.costosCompras[10].costLogistic, this.costosCompras[11].costLogistic], label: '2022' },
                { data: [this.costosCompras[12].costLogistic, this.costosCompras[13].costLogistic, this.costosCompras[14].costLogistic, this.costosCompras[15].costLogistic, this.costosCompras[16].costLogistic, this.costosCompras[17].costLogistic, this.costosCompras[18].costLogistic, this.costosCompras[19].costLogistic, this.costosCompras[20].costLogistic, this.costosCompras[21].costLogistic, this.costosCompras[22].costLogistic, this.costosCompras[23].costLogistic], label: '2023' },
                { data: [this.costosCompras[24].costLogistic, this.costosCompras[25].costLogistic, this.costosCompras[26].costLogistic, this.costosCompras[27].costLogistic, this.costosCompras[28].costLogistic, this.costosCompras[29].costLogistic, this.costosCompras[30].costLogistic, this.costosCompras[31].costLogistic, this.costosCompras[32].costLogistic, this.costosCompras[33].costLogistic, this.costosCompras[34].costLogistic, this.costosCompras[35].costLogistic], label: '2024' },
                { data: [this.costosCompras[36].costLogistic, this.costosCompras[37].costLogistic, this.costosCompras[38].costLogistic, this.costosCompras[39].costLogistic, this.costosCompras[40].costLogistic, this.costosCompras[41].costLogistic, this.costosCompras[42].costLogistic, this.costosCompras[43].costLogistic, this.costosCompras[44].costLogistic, this.costosCompras[45].costLogistic, this.costosCompras[46].costLogistic, this.costosCompras[47].costLogistic], label: '2025' }
            ];
        }
        /***Informe costo import COMEX***/
        if (this.activeCostoImport) {
            this.barChartDataCostoImport = [
                { data: [this.costosImports[0][1], this.costosImports[1][1], this.costosImports[2][1], this.costosImports[3][1], this.costosImports[4][1], this.costosImports[5][1], this.costosImports[6][1], this.costosImports[7][1], this.costosImports[8][1], this.costosImports[9][1], this.costosImports[10][1], this.costosImports[11][1]], label: '2022' },
                { data: [this.costosImports[0][2], this.costosImports[1][2], this.costosImports[2][2], this.costosImports[3][2], this.costosImports[4][2], this.costosImports[5][2], this.costosImports[6][2], this.costosImports[7][2], this.costosImports[8][2], this.costosImports[9][2], this.costosImports[10][2], this.costosImports[11][2]], label: '2023' },
                { data: [this.costosImports[0][3], this.costosImports[1][3], this.costosImports[2][3], this.costosImports[3][3], this.costosImports[4][3], this.costosImports[5][3], this.costosImports[6][3], this.costosImports[7][3], this.costosImports[8][3], this.costosImports[9][3], this.costosImports[10][3], this.costosImports[11][3]], label: '2024' },
                { data: [this.costosImports[0][4], this.costosImports[1][4], this.costosImports[2][4], this.costosImports[3][4], this.costosImports[4][4], this.costosImports[5][4], this.costosImports[6][4], this.costosImports[7][4], this.costosImports[8][4], this.costosImports[9][4], this.costosImports[10][4], this.costosImports[11][4]], label: '2025' }
            ];
        }
