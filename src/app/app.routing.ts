...
const appRoutes: Routes = [
  ...
  { path: 'packing/check-out', component: CheckOutComponent },
  ...
  { path: 'employee/employee-users', component: EmployeeUsersComponent },
  ...
  { path: 'wallet-mtr', component: WalletMTRComponent },
